...
int main() {
    ...
    cout << "--- Eksperimen Pencarian Biner ---\n\n";

    cout << "Hasil Uji Otomatis:\n";
    ...
    if (hasil > 0) {
        cout << "Hasil: Data ditemukan dalam " << hasil << " langkah.\n";
    } else {
        cout << "Hasil: Data TIDAK ditemukan. Proses berlangsung " << -hasil << " langkah.\n";
    }
